...
const authSchema = z.object({
    ...
    a_cargo: z.enum(['si', 'no'], {required_error:'El cargo es obligatorio', invalid_type_error: 'El cargo debe ser una cadena de texto'}),
    jefe_id: z.string({required_error:'El jefe es obligatorio', invalid_type_error: 'El jefe debe ser una cadena de texto'}),
