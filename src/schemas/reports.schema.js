...
const reportSchema = z.object({
    ...
    pais_solicita: z.number({required_error:'El país es obligatorio', invalid_type_error: 'El país debe ser un número'}).int().max(3),
    ...
    area_actual: z.number().int().positive({required_error:'El área es obligatoria', invalid_type_error: 'El área debe ser un número'}),
    area_traslado: z.number().int().positive({required_error:'El área es obligatoria', invalid_type_error: 'El área debe ser un número'}),
    ...
    otro: z.string({invalid_type_error: 'El otro debe ser una cadena de texto'}),
