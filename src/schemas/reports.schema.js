...
const reportSchema = z.object({
    col_id_aplica: z.string({invalid_type_error: 'El ID de la colaboradora debe ser una cadena de texto'}).min(36, {message: 'El ID de la colaboradora debe ser de 36 caracteres'}),
    ...
    motivo_traslado: z.string({invalid_type_error: 'El motivo de traslado debe ser una cadena de texto'}),
